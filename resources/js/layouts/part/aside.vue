        ...
        <div class="space-y-6">
            <div class="sm:space-y-8 space-y-6 pb-2">
                ...
                <div class="flex items-center sm:space-x-6 space-x-3">
                    ...
                    <div class="flex-1">
                        <div class="flex items-center justify-between mb-3">
                            <div class="text-base font-semibold"> <a>  Alex Dolgove </a> </div>
                ...
                <div class="flex items-center sm:space-x-6 space-x-3">
                    ...
                    <div class="flex-1">
                        <div class="flex items-center justify-between mb-3">
                            <div class="text-base font-semibold"> <a> Stella Johnson </a> </div>
                            <div class="font-medium text-sm text-gray-400"> 19 years old</div>
                        </div>
                        <div class="relative">
                            <input type="text" name="" id="" class="with-border" placeholder="Write her on Timeline">
            ...
            <div class="mt-5 sm:space-y-8 space-y-6" id="upcoming" hidden>
                ...
                <div class="flex items-center sm:space-x-6 space-x-3">
                    ...
                    <div class="flex-1">
                        <div class="flex items-center justify-between mb-3">
                            <div class="text-base font-semibold"> <a>  Erica Jones </a> </div>
                            <div class="font-medium text-sm text-gray-400"> 19 years old</div>
                        </div>
                        <div class="relative">
                            <input type="text" name="" id="" class="with-border" placeholder="Write her on Timeline">
                ...
                <div class="flex items-center sm:space-x-6 space-x-3">
                    ...
                    <div class="flex-1">
                        <div class="flex items-center justify-between mb-3">
                            <div class="text-base font-semibold"> <a> Dennis Han </a> </div>
                            <div class="font-medium text-sm text-gray-400"> 19 years old</div>
                        </div>
                        <div class="relative">
                            <input type="text" name="" id="" class="with-border" placeholder="Write her on Timeline">
    ...
    <div class="uk-offcanvas-bar bg-white p-0 w-full lg:w-80 shadow-2xl">
        ...
        <div class="relative pt-5 px-4">
            ...
            <div class="absolute right-3 top-4 flex items-center space-x-2">
                ...
                <a uk-toggle="target: #search;animation: uk-animation-slide-top-small">
...
<div class="story-prev">
    ...
    <div class="story-sidebar uk-animation-slide-left-medium">
        <div class="md:flex justify-between items-center py-2 hidden">
            ...
            <a class="text-blue-600"> Setting</a>
        </div>
