...
class NewfeedController extends Controller
{
    ...
    {
        return Post::where('post_id', $newfeedID)->with('user', 'medias', 'comments', 'reacts', 'shared', 'page')->first();
    }
    ...
    public function share($newfeedID, Request $request)
    {
        try {
            ...
            $this->saveNotification([
                'user_id' => $this->userID,
                'source_id' => $this->getNewFeed($newfeedID)->user_id,
                'title' => null,
                'type' => 1,
